const questions = [
    {
        ...
        answer: 1,
        image: "images/ruins.jpg?v=1",
        failure: {
            title: "失敗：モンスターが混乱！",
            message: "モンスターはさらに混乱し暴れ出した...",
            image: "images/failure1.jpg?v=1"
        }
    },
    {
        ...
        answer: 0,
        image: "images/forest.jpg?v=1",
        failure: {
            title: "失敗：モンスターが激怒！",
            message: "無理に思い出させたせいで、彼は叫び声を上げながら暴走した。",
            image: "images/failure2.jpg?v=1"
        }
    },
    {
        ...
        answer: 0,
        image: "images/stage.jpg?v=1",
        failure: {
            title: "失敗：踊りが大失敗！",
            message: "モンスターは転倒してさらに怒り出しました。",
            image: "images/failure3.jpg?v=1"
        }
    },
    {
        ...
        options: ["正門、、、", "永瀬、、、", "なにわ、、、"],
        answer: 2,
        image: "images/memory.jpg?v=1",
        failure: {
            title: "失敗：彼の心が閉ざされる",
            message: "無理に名前を思い出させようとした結果、西畑は再び混乱して心を閉ざしてしまいました。",
            image: "images/failure4.jpg?v=1"
        }
    },
    {
        ...
        answer: 0,
        image: "images/final.jpg?v=1",
        failure: {
            title: "失敗：最悪の展開",
            message: "彼はモンスターのまま王として君臨し、2度と手の届かない場所へ。",
            image: "images/failure5.jpg?v=1"
        }
    }
];
